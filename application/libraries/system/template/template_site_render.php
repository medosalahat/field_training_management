...
class template_site_render
{
    ...
    public function render_page()
    {
        ...
        $this->CI->template_site->write_view($this->__GET_REGION(),$this->___GET_VIEW_HTML(),$this->get_data());

    }
    public function title($title = null){

        $this->CI->template_site->write('title',$title);
    }

    public function name_page($name_page = null){

        $this->CI->template_site->write('name_page',$name_page);
    }

    public function render(){

        $this->CI->template_site->render();
    }
