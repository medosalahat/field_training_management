...
class CI_Template_tools {
   ...
   function CI_Template_tools()
   {
      $this->CI =& get_instance();
  
      include(APPPATH.'config/template_tools'.EXT);
      if (isset($template))
      {
   ...
   /**
    * Use given template cpanel_super
    *
    * @access  public
    * @param   string   array key to access template cpanel_super
    * @return  void
    */
   ...
   /**
    * Initialize class cpanel_super using config cpanel_super
    *
    * @access  public
